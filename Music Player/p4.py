...
#logo
image_icon=PhotoImage(file='pics\logo.jpg')
root.iconphoto(False,image_icon)

#Browse files button
menu=PhotoImage(file='pics\menu.png')
Label(root,image=menu).place(x=0,y=580,width=485,height=100)

Frame_Music=Frame(root,bd=2,relief=RIDGE)
Frame_Music.place(x=0,y=595,width=485,height=220)

Button(root,text='Browse Music',width=30,height=1,font=('calibri',12,'bold'),fg='black',bg='#009B77',command=AddMusic).place(x=0,y=557)
...
#PlayButton
play_button=PhotoImage(file='pics\play.png')
Button(root,image=play_button,bg='#C8A2C8',bd=0,height=60,width=60,command=PlayMusic).place(x=215,y=487)

#StopButton
stop_button=PhotoImage(file='pics\stop.png')
Button(root,image=stop_button,bg='#9370DB',bd=0,height=60,width=60,command=stop).place(x=130,y=487)


pause_button=PhotoImage(file='pics\pause.png')
Button(root,image=pause_button,bg='#3A5F0B',bd=0,height=60,width=60,command=lambda: pause(paused)).place(x=300,y=487)

#NextButton
next_button=PhotoImage(file='pics\seek.png')
Button(root,image=next_button,bg='#FFFFFF',bd=0,height=60,width=60,command=next_song).place(x=380,y=487)


#PreviousButton
previous_button=PhotoImage(file='pics\previous.png')
Button(root,image=previous_button,bg='#FFFFFF',bd=0,height=60,width=60,command=previous_song).place(x=50,y=487)

#RemoveSong
Button(root,text='Remove Song',width=30,height=1,font=('calibri',12,'bold'),fg='black',bg='#955251',command=delete_song).place(x=250,y=557)
